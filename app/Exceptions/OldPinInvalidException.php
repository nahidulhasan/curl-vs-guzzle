...
class OldPinInvalidException extends Exception
{

    private $errorObj;
    private const ERROR_MESSAGE =  'Old pin you have entered is incorrect. Check and try again';
    private const ERROR_TYPE = 400;
    private const ERROR_CODE = 'ERR_PIN_4420';
    private const ERROR_HINT =  'Old pin you have entered is incorrect. Check and try again';
