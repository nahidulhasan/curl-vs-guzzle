...
class OldPasswordMismatchException extends Exception
{

    private $errorObj;
    private const ERROR_MESSAGE =  'The old password is incorrect. Please,try again';
    private const ERROR_TYPE = 400;
    private const ERROR_CODE = 'ERR_PASS_2220';
    private const ERROR_HINT =  'The old password is incorrect. Please, try again';
